...
//----------------------------------------------------Task2------------------------------------------------------------------------
//Create an array of all products whose category is Soft Drink and print it on the console.

let arOfSftDrnk = productMaster.filter((product) => {
    return product.category === 'Soft Drink'
})

console.log(arOfSftDrnk)
