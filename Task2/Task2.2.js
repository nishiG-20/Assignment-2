...
//----------------------------------------------------Task2------------------------------------------------------------------------
//Sort the array by id in ascending order of id and print it on the console.

productMaster.sort(sortIdInAscOrder)

function sortIdInAscOrder(product1, product2) {
    let id1 = product1.id
    let id2 = product2.id
    if(id1<id2){
        return -1
