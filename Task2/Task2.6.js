...
//----------------------------------------------------Task2------------------------------------------------------------------------
//Create an array of all products with price greater than 16 and quantity greater than 5 and print it on the console.

let arr= productMaster.filter((product) => {
    return product.price >16 && product.quantity>5
})
