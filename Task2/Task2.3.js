...
//----------------------------------------------------Task2------------------------------------------------------------------------
//Sort the array in increasing order of quantity and print it on the console.

productMaster.sort(sortQtyInAscOrder)

function sortQtyInAscOrder(product1, product2) {
    let qty1 = product1.quantity
    let qty2 = product2.quantity
    if (qty1 < qty2) {
        return -1
    } else if (qty1 > qty2) {
        return 1
